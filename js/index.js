...
angular.module('shopApp',['ngRoute'])
    .controller('Discover', function ($scope, $route) {
        $scope.$route = $route;
        banner();
    })
    ...
    $routeProvider
        ...
        .when('/mh',{
            templateUrl: 'view/toiletry.html',
            controller: 'HomeController'
        })
        .when('/gx',{
            templateUrl: 'view/ornament.html',
            controller: 'AboutController'
        })
        .when('/tswk',{
            templateUrl: 'view/tswk.html'
        })
        .when('index.html',{
            templateUrl: 'view/discover.html',
            controller: 'HomeController'
...
function banner() {
    ...
    //  获取 轮播图的ul
    var moveUl = document.getElementsByClassName('moveUl')[0];
    var lis = moveUl.querySelectorAll('li');
    var len = lis.length;
    // 设置moveUl的宽
    moveUl.style.width = ((len+1) * width) + 'px';
...
var nav = document.getElementById('nav_still');
link(nav);
